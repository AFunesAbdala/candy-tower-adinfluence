    ...
    <main className="min-h-screen w-full flex flex-col justify-center items-center">
      <div className="w-[95%] h-[95vh] rounded-2xl border border-purpleCandy flex flex-col justify-between overflow-hidden">
        ...
        <div className="w-full h-auto flex flex-col gap-5">
          {/* HEADER */}
          <div className="h-auto py-4 px-6 flex flex-row justify-between items-center bg-white border-b border-purpleCandy">

            {/* IMAGEN DE MARCA */}
            <Image src={Logo} className="w-16 object-contain" alt="The Candy Tower"></Image>

            {/* TITULO */}
            <h1 className="balooBold text-purpleCandy text-3xl">
              Mi Torre de Dulces
            </h1>

            {/* AGREGAR AL CARRITO */}
            <button className="balooBold text-white h-10 px-4 rounded-md bg-pinkCandy shadow-darkShadowPink ">
              Agregar al Carrito
            </button>
          </div>

          {/* PANELES CENTRALES */}
          <div className="w-full px-6 flex flex-row justify-between items-start">
            ...
            <div className="w-fit flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="w-fit flex flex-col gap-1">
                  <h3 className="text-sm font-Muli font-bold text-darkGrey">Estructura</h3>
                  <div className="flex flex-row gap-3">
                    <button className="h-10 px-4 rounded-md bg-pinkCandy shadow-darkShadowPink text-sm text-white font-Muli font-bold">Pirámide</button>
                  </div>
                </div>

                {/* Pisos */}
                <div className="w-fit flex flex-col gap-1">
                  <h3 className="text-sm font-Muli font-bold text-darkGrey">Cantidad de Pisos</h3>
                  <div className="flex flex-row gap-3">
                    <button
                      className={`w-10 h-10 rounded-md text-sm font-bold leading-none bg-white border ${floors != 2 ? "shadow-darkShadowGrey border-darkGrey text-darkGrey hover:bg-lightPinkCandy hover:border-pinkCandy" : "shadow-darkShadowLightGrey border-lightGrey text-lightGrey"} font-bold text-center duration-200`}
                      onClick={handleSubtractFloor}
                      {...(floors != 2 ? {} : { disabled: true })}
                    >-</button>
                    <div className="flex flex-col justify-center w-10 h-10 rounded-md text-sm text-white text-center font-bold bg-pinkCandy shadow-darkShadowPink"><span>{floors}</span></div>
                    <button
                      className={`w-10 h-10 rounded-md text-sm font-bold leading-none bg-white border ${floors != 6 ? "shadow-darkShadowGrey border-darkGrey text-darkGrey hover:bg-lightPinkCandy hover:border-pinkCandy" : "shadow-darkShadowLightGrey border-lightGrey text-lightGrey"} font-bold text-center duration-200`}
                ...
                <div className="w-fit flex flex-col gap-1">
                  <h3 className="text-sm font-Muli font-bold text-darkGrey">Seleccionar Piso</h3>
                  <div className="w-[150px] xl:w-[200px] flex flex-row flex-wrap gap-3">
                    {Array.from({ length: floors }).map((_, index) => {
                      const floor = index + 1
                      return (
                        <button
                          key={index}
                          className={`w-10 h-10 rounded-md text-sm font-bold leading-none border ${isFloorSelected === floor ? "bg-pinkCandy border-pinkCandy shadow-darkShadowPink text-white" : "bg-white border-darkGrey shadow-darkShadowGrey text-darkGrey hover:bg-lightPinkCandy hover:border-pinkCandy"} duration-200`}
                          onClick={() => handleSelectFloor(floor)}
                        >{floor}</button>
                      )
                    })}
                    <button
                      className={`flex flex-col items-center justify-center w-10 h-10 rounded-md text-sm font-bold leading-none border ${isFloorSelected === 0 ? "bg-pinkCandy border-pinkCandy shadow-darkShadowPink text-white" : "bg-white border-darkGrey shadow-darkShadowGrey text-darkGrey hover:border-pinkCandy hover:bg-lightPinkCandy"} duration-200`}
                      onClick={() => handleSelectFloor(0)}
                    >
                      <Image src={isFloorSelected === 0 ? CoronaIconWhite : CoronaIconGrey} className="w-7 h-7 object-contain"></Image>
                    </button>
                  </div>
                </div>
              </div>
            ...
            {/* DETALLE */}
            <div className="h-fit w-[400px] flex flex-row justify-end items-center">

              {/* HIDE/SHOW BOTON DETALLE */}
              {
                detalleHidden
                  ?
                  /* SI DETALLE ESTA ESCONDIDO RENDERIZAR EL BOTON "VER DETALLE" */
                  <button
                    className="flex flex-row items-center h-10 border border-purpleCandy rounded-md bg-purpleCandy overflow-hidden"
                    onClick={() => hideDetalle()}
                  >
                    <Image src={Arrow} className="w-10 h-10 bg-white object-contain"></Image>
                    <span className="balooBold px-4 font-Baloo text-white text-sm">Ver Detalle</span>
                  </button>
                  :
                  /* SI DETALLE ESTA VISIBLE RENDERIZAR EL "DETALLE" */
                  <div className="relative h-fit w-[400px] flex flex-row items-center bg-white rounded-2xl border border-purpleCandy">
                    <button
                      className="absolute -left-5 h-10 w-10 bg-white rounded-md border border-purpleCandy overflow-hidden"
                      onClick={() => hideDetalle()}
                    >
                      <Image src={Arrow} className="w-10 h-10 rotate-180 bg-white object-contain"></Image>
                    </button>

                    <div className="w-full h-full">
                      <div className="w-full py-2 flex flex-col items-center justify-center bg-purpleCandy rounded-t-xl">
                      ...
                      <div className="w-full py-4 rounded-b-2xl flex flex-row justify-between items-center px-4 bg-lightPurpleCandy">
          ...
          isCorona
            ...
            <div className="w-full px-6 flex flex-col gap-1">
              ...
              <div className="flex flex-row gap-2 mb-2">
                <form className="flex flex-row items-center gap-2">
                  <input
                    className="h-8 w-80 border border-darkGrey rounded-md bg-white shadow-darkShadowGrey px-2 font-Muli text-darkGrey focus:bg-lightPinkCandy focus:border-pinkCandy outline-none"
                  ></input>
                  <button
                    type="submit"
                ...
                <div className="relative">
                  <button
                    className={`h-8 rounded-md lg:px-3 border ${!orderHidden ? "bg-pinkCandy border-pinkCandy shadow-darkShadowPink text-white" : "bg-white border-darkGrey shadow-darkShadowGrey hover:border-pinkCandy hover:bg-lightPinkCandy"}`}
                    onClick={() => hideOrder()}
                  >
                    <Image></Image>
                    <h3 className="font-Muli text-sm font-bold">Ordenar</h3>
                  </button>
                  {
                    !orderHidden &&
                ...
                <div className="relative">
                  <button
                    className={`h-8 rounded-md lg:px-3 border ${!filterHidden ? "bg-pinkCandy border-pinkCandy shadow-darkShadowPink text-white" : "bg-white border-darkGrey shadow-darkShadowGrey hover:border-pinkCandy hover:bg-lightPinkCandy"}`}
                    onClick={() => hideFilter()}
                  >
                    <Image></Image>
                    <h3 className="font-Muli text-sm font-bold">Filtrar</h3>
                  </button>
                  {
                    !filterHidden &&
                    <div className="absolute right-0 bottom-full mb-2 w-[300px] h-fit p-4 bg-white border border-darkGrey rounded-md">
                      <div className="flex flex-col gap-2">
            ...
            <div className="w-full px-6 flex flex-col gap-1">
              ...
              <div className="flex flex-row gap-2 mb-2">
                ...
                <div className="relative">
                  <button
                    className={`h-8 font-Muli rounded-md md:px-3 border ${!orderHidden ? "bg-pinkCandy border-pinkCandy shadow-darkShadowPink text-white" : "bg-white border-darkGrey shadow-darkShadowGrey hover:border-pinkCandy hover:bg-lightPinkCandy"}`}
                    onClick={() => hideOrder()}
                  >
                    <Image></Image>
                    <h3 className="font-Muli text-sm font-bold">Ordenar</h3>
                ...
                <div className="relative">
                  <button
                    className={`h-8 font-Muli rounded-md md:px-3 border ${!filterHidden ? "bg-pinkCandy border-pinkCandy shadow-darkShadowPink text-white" : "bg-white border-darkGrey shadow-darkShadowGrey hover:border-pinkCandy hover:bg-lightPinkCandy"}`}
                    onClick={() => hideFilter()}
                  >
                    <Image></Image>
                    <h3 className="font-Muli text-sm font-bold">Filtrar</h3>
